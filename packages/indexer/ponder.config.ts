...
// Deployed ReceiptHook address and start block
const RECEIPT_HOOK_ADDRESS = '0x15d3b7CbC9463f92a88cE7B1B384277DA741C040';
const RECEIPT_HOOK_START_BLOCK = 10165500;
